...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel header = createHeader("Computers");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == firstButton) {
			askQuestion("What am I making this on?", "imac", 200);
			firstButton.setText(" ");
		}
		if (e.getSource() == secondButton) {
			askQuestion("How much money is this question worth?", "400", 400);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// the question
		JOptionPane.showMessageDialog(null, "Don't forget no caps!");
